(function () {
    function d() {
        if ((i === "checkout_contact_view" || i === "checkout_all_view" || i === "checkout_payment_view") && (n.value = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.value : "", n.content_ids = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.content_ids : [], n.metadata.num_items = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.num_items : 0, n.contents = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.contents : []), i === "product_view" || i === "product_view_from_search") {
            ...
            n.contents = [Object.assign({}, f, {item_price: f.price}, {price: null})]
        }
        t.postData(c, n, u, r)
    }
    ...
    function vt() {
        ...
        n.contents = Bizweb.checkout.line_items.map(function (n) {
            return {id: n.variant_id, quantity: n.quantity, item_price: n.price_final, name: n.title}
        });
        t.postData(c, n, u, r);
        n.action = "purchase";
    ...
    var y = window.BizwebAnalytics.tracking_url, s = t.getCookie("_s"), e = t.getCookie("_v"),
        it = !!sessionStorage.getItem("active"), rt = t.getCookie("_landing_full_page"),
        ut = t.getCookie("_landing_type"), ft = unescape(t.getCookie("_landing_page")), l = !1;
    e && (p = t.getCookie("_v_new"), p || (l = !0));
    var h = t.getCookie("_origin_reference_site"), c = y + "/api/v1/page-views", f = y + "/api/v1/product-actions",
        u = function () {
            t.setCookie("_s", s, 30);
    ...
    var et = Bizweb ? Bizweb.id : 0, ot = document.referrer, st = h, ht = s, ct = e, lt = location.href, w = !1, i, b,
        k = !1;
